...
def load_members(filepath: str = "members.txt") -> list[Member]:
    ...
    try:
        ...
        print("The file is corrupted:", error.msg)
        return []


def add_member(
    members: list[Member], member: Member,
    filepath: str = "members.txt"
) -> None:
...
def find_member(members: list[Member], member_id: str) -> Member | None:
